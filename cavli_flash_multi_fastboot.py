...
def main(flash_function=flash_fastboot_function):
    ...
    try:
        ...
        detect_thread = threading.Thread(target=usb_fastboot_detect, 
                            args=(active_ports, lambda port, prog=progress: on_new_device(port, flash_function, active_ports, prog), progress))
        detect_thread.start()
